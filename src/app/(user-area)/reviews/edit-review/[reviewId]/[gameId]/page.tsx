...
export default async function EditReviewPage({ params }: EditReviewPageProps) {
  ...
  return (
    <section className="w-full min-h-full pt-6 lg:py-6 md:px-5 flex flex-1 flex-col items-center box-border">
      <div className="w-full min-h-full flex flex-1 flex-col justify-center items-center lg:w-[90%] 2xl:w-[70%]">
